...
def insert_fx_pairs(db):
    ...
    fx_pairs = [
        ...
        {"ticker": "USDCNH=X", "ticker_tradingview": "FX_IDC:USDCNH", "name": "U.S. Dollar / Chinese Yuan (Offshore)", "region": ["US", "China"], "prompt": FX_LONG_SHORT_PROMPT, "factors": FX_FACTORS_PROMPT, "model_function": "run_fx_model", "model_name":"fx_long_short", "asset_class": "FX", "importance": 5, "recurrence": "multi", "decimal": 4, "document_generated": False},
...
def insert_indices(db):
    ...
    indices = [
        ...
        {"ticker": "^TOPX", "ticker_tradingview": "TVC:TOPIX", "name": "TOPIX", "region": ["Japan"], "prompt": IX_INDEX_LONG_SHORT_PROMPT, "factors": IX_INDEX_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "IX, EQ", "importance": 4, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "^SSEC", "ticker_tradingview": "TVC:SHCOMP", "name": "Shanghai Composite", "region": ["China"], "prompt": IX_INDEX_LONG_SHORT_PROMPT, "factors": IX_INDEX_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "IX, EQ", "importance": 4, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "399006.SZ", "ticker_tradingview": "SZSE:399006", "name": "ChiNext Index", "region": ["China"], "prompt": IX_INDEX_LONG_SHORT_PROMPT, "factors": IX_INDEX_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "IX, EQ", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "^SPTSX", "ticker_tradingview": "TVC:TSX", "name": "S&P/TSX Composite", "region": ["Canada"], "prompt": IX_INDEX_LONG_SHORT_PROMPT, "factors": IX_INDEX_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "IX, EQ", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
...
def insert_energy_commodities(db):
    ...
    energy_commodities = [
        ...
        {"ticker": "QL=F", "ticker_tradingview": "NYMEX:QL1!", "name": "Crude Oil Dubai", "region": ["Middle East", "Asia"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "LCO=F", "ticker_tradingview": "ICE:BRN1!", "name": "ICE Brent Crude", "region": ["UK", "Global"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "QLNG=F", "ticker_tradingview": "ICE:JKM1!", "name": "LNG Japan Korea Marker", "region": ["Japan", "South Korea"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "API2=F", "ticker_tradingview": "ICE:API2", "name": "Coal (Europe API2)", "region": ["Europe"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "API4=F", "ticker_tradingview": "ICE:API4", "name": "Coal (South Africa API4)", "region": ["South Africa"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "UX=F", "ticker_tradingview": "NYMEX:UX1!", "name": "Uranium UxC", "region": ["Global"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "NEWC=F", "ticker_tradingview": "ICE:NEWC", "name": "Newcastle Coal (Australia)", "region": ["Australia", "Asia"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "AUSLNG=F", "ticker_tradingview": "ICE:AUSLNG", "name": "Australian LNG (North Asia Spot)", "region": ["Australia", "Asia"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "AUSELEC=F", "ticker_tradingview": "ASX:ELEC1!", "name": "Australian Electricity Futures", "region": ["Australia"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "SC=F", "ticker_tradingview": "INE:SC1!", "name": "China Crude Oil (INE)", "region": ["China"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "LNGCN=F", "ticker_tradingview": "SHFE:LNG1!", "name": "China LNG Domestic Gas", "region": ["China"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "CNEL=F", "ticker_tradingview": "SHFE:ELEC1!", "name": "China Electricity Futures", "region": ["China"], "prompt": EN_ENERGY_LONG_SHORT_PROMPT, "factors": EN_ENERGY_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "EN", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False}
    ]
...
def insert_metal_commodities(db):
    ...
    metal_commodities = [
        ...
        {"ticker": "AL=F", "ticker_tradingview": "LME:AL", "name": "Aluminium", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "PB=F", "ticker_tradingview": "LME:PB", "name": "Lead", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "NI=F", "ticker_tradingview": "LME:NI", "name": "Nickel", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "CO=F", "ticker_tradingview": "LME:CO", "name": "Cobalt", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "MCC=F", "ticker_tradingview": "SHFE:CU", "name": "China Copper (SHFE)", "region": ["China"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "ALCN=F", "ticker_tradingview": "SHFE:AL", "name": "China Aluminium (SHFE)", "region": ["China"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "ZNCN=F", "ticker_tradingview": "SHFE:ZN", "name": "China Zinc (SHFE)", "region": ["China"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "NICN=F", "ticker_tradingview": "SHFE:NI", "name": "China Nickel (SHFE)", "region": ["China"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "XAU=AUD", "ticker_tradingview": "ASX:XAU", "name": "Gold (Australia)", "region": ["Australia"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "XAG=AUD", "ticker_tradingview": "ASX:XAG", "name": "Silver (Australia)", "region": ["Australia"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False}
    ]
...
def insert_livestock_commodities(db):
    ...
    livestock_commodities = [
        ...
        {"ticker": "LCN=F", "ticker_tradingview": "DCE:CATTLE", "name": "China Live Cattle (DCE)", "region": ["China"], "prompt": LI_LIVESTOCK_LONG_SHORT_PROMPT, "factors": LI_LIVESTOCK_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "LI", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "LHN=F", "ticker_tradingview": "DCE:HOG", "name": "China Lean Hogs (DCE)", "region": ["China"], "prompt": LI_LIVESTOCK_LONG_SHORT_PROMPT, "factors": LI_LIVESTOCK_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "LI", "importance": 5, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "XLC=F", "ticker_tradingview": "ASX:LC", "name": "Australia Live Cattle (ASX)", "region": ["Australia"], "prompt": LI_LIVESTOCK_LONG_SHORT_PROMPT, "factors": LI_LIVESTOCK_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "LI", "importance": 4, "recurrence": "multi", "decimal":2, "document_generated": False},
        {"ticker": "XLH=F", "ticker_tradingview": "ASX:LH", "name": "Australia Lean Hogs (ASX)", "region": ["Australia"], "prompt": LI_LIVESTOCK_LONG_SHORT_PROMPT, "factors": LI_LIVESTOCK_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "LI", "importance": 4, "recurrence": "multi", "decimal":2, "document_generated": False}
    ]
...
def insert_crypto_assets(db):
    ...
    crypto_assets = [
        ...
        {"ticker": "MATIC-USD", "ticker_tradingview": "COINBASE:MATICUSD", "name": "Polygon / U.S. Dollar", "region": ["Global"], "prompt": CR_CRYPTO_LONG_SHORT_PROMPT, "factors": CR_CRYPTO_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "CR", "importance": 4, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "UNI-USD", "ticker_tradingview": "COINBASE:UNIUSD", "name": "Uniswap / U.S. Dollar", "region": ["Global"], "prompt": CR_CRYPTO_LONG_SHORT_PROMPT, "factors": CR_CRYPTO_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "CR", "importance": 3, "recurrence": "multi", "decimal":2, "document_generated": False},
        ...
        {"ticker": "STX-USD", "ticker_tradingview": "COINBASE:STXUSD", "name": "Stacks / U.S. Dollar", "region": ["Global"], "prompt": CR_CRYPTO_LONG_SHORT_PROMPT, "factors": CR_CRYPTO_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "CR", "importance": 3, "recurrence": "multi", "decimal":2, "document_generated": False}
    ]
