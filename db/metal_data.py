...
def insert_metal_commodities(db):
    ...
    metal_commodities = [
        {"ticker": "GC=F", "ticker_tradingview": "OANDA:XAUUSD", "name": "Gold", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 1, "recurrence": "multi", "decimal":2, "document_generated": True},
        {"ticker": "SI=F", "ticker_tradingview": "OANDA:XAGUSD", "name": "Silver", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 1, "recurrence": "multi", "decimal":3, "document_generated": True},
        {"ticker": "PL=F", "ticker_tradingview": "OANDA:XPTUSD", "name": "Platinum", "region": ["Global"], "prompt": ME_METALS_LONG_SHORT_PROMPT, "factors": ME_METALS_FACTORS_PROMPT, "model_function": "run_holistic_market_model", "model_name":"holistic", "asset_class": "ME", "importance": 1, "recurrence": "multi", "decimal":2, "document_generated": True}
    ]
