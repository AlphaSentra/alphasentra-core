...
def get_ai_weights(tickers, factor_weights_prompt, weights_percent, model_name=None, batch_mode=False):
    """
    ...
    try:        
        ...
        while retry_count < max_retries and not parse_success:
            try:
                ...
                ai_response = get_gen_ai_response([tickers_str], "factors analysis", formatted_prompt, batch_mode=batch_mode)
